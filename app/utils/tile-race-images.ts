...
const TILE_IMAGE_RULES: ITileImageRule[] = [
  // Raids
  {
    keywords: ['corrupted gauntlet', 'cg', 'hunllef'],
    image: 'Corrupted_Hunllef.png',
  },
  { keywords: ['gauntlet'], image: 'The_Gauntlet.png' },
  {
    keywords: ['chambers of xeric', 'chambers', 'cox', 'olm'],
    image: 'Great_Olm.png',
  },
  {
    keywords: ['theatre of blood', 'theatre', 'tob', 'verzik'],
    image: 'Verzik_Vitur.png',
  },
  {
    keywords: ['tombs of amascut', 'tombs', 'toa', 'amascut', 'warden'],
    image: 'Tumeken%27s_Warden_(level-544).png',
  },
  ...
  // Wilderness
  {
    keywords: ['revenant', 'revenants', 'rev', 'revs'],
    image: 'Revenant_maledictus.png',
  },
  { keywords: ['callisto', 'artio'], image: 'Callisto.png' },
  { keywords: ['venenatis', 'spindel'], image: 'Venenatis.png' },
  {
    keywords: ["vet'ion", 'vetion', "calvar'ion", 'calvarion'],
    image: 'Vet%27ion.png',
  },
  ...
  // Slayer bosses
  {
    keywords: ['alchemical hydra', 'hydra'],
    image: 'Alchemical_Hydra_(serpentine).png',
  },
  ...
  {
    keywords: ['thermonuclear', 'thermy', 'smoke devil'],
    image: 'Thermonuclear_smoke_devil.png',
  },
  {
    keywords: ['grotesque guardians', 'grotesque', 'dusk', 'dawn'],
    image: 'Dawn.png',
  },
  ...
  {
    keywords: ['kalphite queen', 'kalphite', 'kq'],
    image: 'Kalphite_Queen.png',
  },
  { keywords: ['giant mole', 'mole'], image: 'Giant_Mole.png' },
  {
    keywords: ['dagannoth kings', 'dagannoth', 'dks'],
  ...
  {
    keywords: ['moons of peril', 'moons', 'perilous', 'lunar chest'],
    image: 'Eclipse_Moon.png',
  },
  ...
  {
    keywords: ['clue', 'clues', 'casket', 'caskets'],
    image: 'Reward_casket_(hard)_detail.png',
  },
];
